...
CREATE TABLE `login_role` (
  ...
  KEY `FK63kgx3alku7oht20p6r560u95` (`role_id`),
  CONSTRAINT `FK63kgx3alku7oht20p6r560u95` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`),
  CONSTRAINT `FK9bqlp09e2a52fdq1ywjha2iti` FOREIGN KEY (`login_id`) REFERENCES `login` (`login_id`)
...
INSERT INTO `login_role` VALUES (3,2),(4,2),(6,2),(7,2),(18,2),(17,3),(19,3),(20,3),(21,3),(22,3),(23,3),(24,3);
